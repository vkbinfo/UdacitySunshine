...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        assertTrue(contentValues.get(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING).equals(cursor.getString(2)));
    ...
    public void testWeatherTable() {
        ...
        // Create ContentValues of what you want to insert
        // (you can use the createNorthPoleLocationValues if you wish)
        ContentValues contentValues=TestUtilities.createWeatherValues(insert());
        ...
        TestUtilities.validateCurrentRecord("ncsbcsibi",cursor,contentValues);
        // Insert ContentValues into database and get a row ID back
